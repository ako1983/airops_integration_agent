...
class ParameterGeneratorTool(BaseTool):
    name: ClassVar[str]  = "parameter_generator"
    description: ClassVar[str] = "Generates parameters for an integration action based on schema"
    args_schema: ClassVar[type] = GeneratorInput
